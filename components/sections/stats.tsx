...
export function StatsSection() {
  return (
    <div className="mx-auto max-w-[1440px] px-6 -mt-20 relative z-10">
      <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-10 grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 text-center">
        {stats.map((stat, idx) => (
          <div 
            key={stat.label} 
          ...
          >
            <h3 className="text-3xl sm:text-5xl font-extrabold text-[var(--red)] mb-2">{stat.value}</h3>
